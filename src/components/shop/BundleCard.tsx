...
export function BundleCard({ bundle }: BundleCardProps) {
  return (
    <Link href={`/bundles/${bundle.slug}`} className="group block">
      <div className="relative aspect-[4/5] overflow-hidden bg-ok-cream sticker transition-transform duration-300 group-hover:-translate-y-1 group-hover:rotate-[0.5deg]">
        <Image
          src={bundle.image}
          alt={bundle.name}
          fill
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-ok-black/85 to-transparent p-4 pt-16">
          <p className="inline-flex rotate-[-2deg] bg-ok-yellow px-2 py-0.5 font-mono text-[10px] font-bold uppercase tracking-[0.16em] text-ok-black">
