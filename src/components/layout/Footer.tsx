      ...
      <div className="mx-auto grid max-w-[1400px] gap-10 px-4 py-14 md:grid-cols-12 md:px-6 md:py-16">
        <div className="md:col-span-5">
          <div className="flex items-center gap-3">
            <BrandLogo size={56} href={false} />
            <p className="font-[family-name:var(--font-display)] text-2xl font-bold uppercase tracking-tight md:text-3xl">
          ...
          <p className="mt-6 font-mono text-[11px] uppercase tracking-[0.18em] text-ok-yellow">
            Browse. Message. Done.
          </p>
        </div>
